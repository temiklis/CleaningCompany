        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RenderedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryPerHour = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderRequestsId = table.Column<int>(type: "int", nullable: false),
                    ProductsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderRequestProduct", x => new { x.OrderRequestsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_OrderRequestProduct_OrderRequests_OrderRequestsId",
                        column: x => x.OrderRequestsId,
                        principalTable: "OrderRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderRequestProduct_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponsibleEmployeesId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeOrder", x => new { x.AssignedOrdersId, x.ResponsibleEmployeesId });
                    table.ForeignKey(
                        name: "FK_EmployeeOrder_AspNetUsers_ResponsibleEmployeesId",
                        column: x => x.ResponsibleEmployeesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeOrder_Orders_AssignedOrdersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeOrder_ResponsibleEmployeesId",
                table: "EmployeeOrder",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderRequestProduct_ProductsId",
                table: "OrderRequestProduct",
                column: "ProductsId");
